...
class ChronicClass:
    ...
    def __init__(self, column_list, to_drop_list, test_size_split, number_of_epochs, activation_fun):
...
columns_list1 = ['sg', 'al', 'sc', 'hemo', 'pcv', 'wbcc', 'rbcc', 'htn', 'classification']
